...
public interface LeaveDao extends BaseMapper<BizLeave> {
     ...
     * 根据ID查询请假详情（带班级名称）
     */
    @Select("SELECT l.*, c.class_name as className " +
            "FROM biz_leave l " +
            "LEFT JOIN edu_class c ON l.class_id = c.id " +
